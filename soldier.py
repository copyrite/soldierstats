...
ANCEV2_SWAPS = (
    StatSwap("Offense", 0, "Will", 3, 1.0),
    StatSwap("Offense", 0, "Will", 6, 1.0),
    StatSwap("Offense", 0, "Mobility", 1, 1.5),
    StatSwap("Offense", 0, "HP", 1, 1.5),
    StatSwap("Offense", 0, "Hacking", 3, 0.5),
    StatSwap("Offense", 0, "PsiOffense", 3, 1.0),
    StatSwap("Offense", 0, "PsiOffense", 6, 1.0),
    StatSwap("Offense", 0, "Dodge", 3, 1.0),
    StatSwap("Offense", 0, "Dodge", 6, 0.5),
    StatSwap("HP", 0, "Mobility", 1, 2.0),
    StatSwap("HP", 0, "PsiOffense", 12, 1.0),
    StatSwap("Mobility", 0, "PsiOffense", 12, 1.0),
    StatSwap("Dodge", 0, "Will", 1, 1.0),
    StatSwap("Dodge", 0, "Will", 2, 1.0),
    StatSwap("Dodge", 0, "Will", 3, 1.0),
    StatSwap("Dodge", 0, "Will", 4, 1.0),
    StatSwap("Dodge", 0, "Hacking", 1, 0.5),
    StatSwap("Dodge", 0, "Hacking", 2, 0.5),
    StatSwap("Dodge", 0, "Hacking", 3, 0.5),
    StatSwap("Dodge", 0, "Hacking", 4, 0.5),
    StatSwap("Dodge", 0, "PsiOffense", 4, 1.0),
    StatSwap("Dodge", 0, "PsiOffense", 5, 1.0),
    StatSwap("Dodge", 0, "PsiOffense", 6, 1.0),
    StatSwap("Dodge", 0, "PsiOffense", 7, 1.0),
    StatSwap("Will", 0, "Hacking", 1, 0.5),
    StatSwap("Will", 0, "Hacking", 2, 0.5),
    StatSwap("Will", 0, "PsiOffense", 4, 0.5),
    StatSwap("Will", 0, "PsiOffense", 5, 1.0),
    StatSwap("Will", 0, "PsiOffense", 6, 1.0),
    StatSwap("Will", 0, "PsiOffense", 7, 1.0),
    StatSwap("Offense", 1, "Will", 0, 1.0),
    StatSwap("Offense", 2, "Will", 0, 1.0),
    StatSwap("Offense", 4, "Mobility", 0, 1.5),
    StatSwap("Offense", 4, "HP", 0, 1.5),
    StatSwap("Offense", 1, "Hacking", 0, 0.5),
    StatSwap("Offense", 1, "PsiOffense", 0, 1.0),
    StatSwap("Offense", 2, "PsiOffense", 0, 1.0),
    StatSwap("Offense", 1, "Dodge", 0, 1.0),
    StatSwap("Offense", 2, "Dodge", 0, 0.5),
    StatSwap("HP", 1, "Mobility", 0, 2.0),
    StatSwap("HP", 1, "PsiOffense", 0, 1.0),
    StatSwap("Mobility", 1, "PsiOffense", 0, 1.0),
    StatSwap("Dodge", 1, "Will", 0, 1.0),
    StatSwap("Dodge", 2, "Will", 0, 1.0),
    StatSwap("Dodge", 3, "Will", 0, 1.0),
    StatSwap("Dodge", 4, "Will", 0, 1.0),
    StatSwap("Dodge", 1, "Hacking", 0, 0.5),
    StatSwap("Dodge", 2, "Hacking", 0, 0.5),
    StatSwap("Dodge", 3, "Hacking", 0, 0.5),
    StatSwap("Dodge", 4, "Hacking", 0, 0.5),
    StatSwap("Dodge", 4, "PsiOffense", 0, 1.0),
    StatSwap("Dodge", 5, "PsiOffense", 0, 1.0),
    StatSwap("Dodge", 6, "PsiOffense", 0, 1.0),
    StatSwap("Dodge", 7, "PsiOffense", 0, 1.0),
    StatSwap("Will", 1, "Hacking", 0, 0.5),
    StatSwap("Will", 2, "Hacking", 0, 0.5),
    StatSwap("Will", 4, "PsiOffense", 0, 0.5),
    StatSwap("Will", 5, "PsiOffense", 0, 1.0),
    StatSwap("Will", 6, "PsiOffense", 0, 1.0),
    StatSwap("Will", 7, "PsiOffense", 0, 1.0),
)
